...
import type { Interaction, ResolvedConflict, QuestionMode, AnswerType } from '../types/jd.types';
          ...
          >
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0 flex-1">
                ...
                {!isEditing && (
                  <p className="break-words text-xs font-semibold text-info">{group.displayAnswer}</p>
                )}
              </div>
                ...
                <div className="flex flex-col gap-2">
                  {group.items.map((item) => (
                    ...
                    >
                      ...
                      <p className="mb-0.5 text-xs font-semibold text-text">{item.question_text}</p>
                      <p className="break-words text-xs font-medium text-info">
